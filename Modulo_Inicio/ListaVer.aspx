<%@ Page Title="" Language="C#" MasterPageFile="~/Menus/Menu_Inicio_sinPermisos.master" AutoEventWireup="true" CodeFile="ListaVer.aspx.cs" Inherits="Modulo_Inicio_ListaVer" %>
    ...
    <table width="100%" >
            <tr>
                <td class="style4">
                    &nbsp;</td>
                <td align="right">
                    <asp:TextBox ID="Tbx_Buscar" class="floatl__input" runat="server" Height="5px" ></asp:TextBox>
                    &nbsp;<asp:Button ID="Btn_Mostrar" runat="server" Text="Buscar" onclick="Btn_Mostrar_Click" width="10%" class="boton buscar"/>
                </td>
            </tr>
        </table><br /><br />
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id_Proyecto" 
            ...
            <AlternatingItemTemplate>
                <tr style="background-color: #E0FFFF;color: #333333;" class="contenedor">
                    ...
                    <td>
                        <asp:Label ID="NombreLabel" runat="server" Text='<%# Eval("Nombre") %>' /></td>

                    <td>
                        <asp:Label ID="Registro_VIELabel" runat="server" Text='<%# Eval("Registro_VIE") %>' /></td>
                    <td>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT [Id_Proyecto], [Nombre], [Registro_VIE] FROM [Proyectos] ORDER BY [Fecha_Registro_VIE] DESC"></asp:SqlDataSource>
            <div style="width: 100%;">
