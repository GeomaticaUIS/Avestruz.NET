...
public partial class Lista : System.Web.UI.Page
{
    ...
    private void CreateTitles(ExcelWorksheet ws, DataTable dt)
    {
        ...
        ws.Cells[2, 5].Value = "Valor Final Contratado";
    ...
    private static SqlDataAdapter ConnectToDB()
    {
        ...
        string sql = null;
        SqlConnection cnn;
        connectionString = @"Data Source=10.1.90.14;Initial Catalog=PROYECTOSGEOMATICA;User ID=Consolidado;Password=Pr0y3ct0sG30m@t1c4";
