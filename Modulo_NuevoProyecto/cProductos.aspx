<%@ Page Title="" Language="C#" MasterPageFile="~/Menus/Menu_NuevoProyecto.master" AutoEventWireup="true" CodeFile="cProductos.aspx.cs" Inherits="zNuevo_cProductos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div align="center">
        ...
        <table style="width: 900px">
            <tr>
                ...
                <td colspan="3" style="text-align: left">
                    <asp:TextBox ID="Txt_Nombre" runat="server" class="floatl__input" Height="26px" Width="521px" ValidationGroup="Validar_InfoGeneral"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="text-align: left" class="style1">
                    <asp:DropDownList ID="DropDownList1" class="dropdownlist" runat="server" Height="32px" Width="180px" 
                ...
                <td style="text-align: left">
                    <asp:TextBox ID="Txb_Ubicacion" runat="server" class="floatl__input" Height="26px" Width="163px"></asp:TextBox>
                </td>
            </tr>
            <tr>
            <td class="style4"></td>
                ...
                <td colspan="3" style="text-align: left">
                    <asp:TextBox ID="Txt_descripcion" runat="server" class="floatl__input" Height="99px" Width="521px" TextMode="MultiLine"></asp:TextBox>
        ...
        <fieldset>
        <h2> Agregar Colaboradores </h2><br /><asp:Label ID="Lbl_estadoColaboradores" runat="server"></asp:Label><br /> <br />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="Btn_AñadirColaborador" runat="server" Text="+" 
                    Width="10%" onclick="Btn_AñadirColaborador_Click" class="boton buscar"/>
                ...
                <td>&nbsp;<asp:DropDownList ID="DropDownList8" runat="server" 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Text="Agregar" onclick="Agregar_Click" class="boton buscar"/>
                    <asp:Button ID="Btn_terminar2" runat="server" Text="Terminar" onclick="Btn_terminar2_Click" class="boton buscar"/>
