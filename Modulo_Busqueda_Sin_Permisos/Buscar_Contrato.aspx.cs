...
public partial class Modulo_Busqueda_Buscar_VIE : System.Web.UI.Page
{
    ...
    protected void VerProyecto_Click(object sender, EventArgs e)
    {
        ...
        /*Revisar ID_Contrato, dado que no siempre coincide con ID_Proyecto*/
        Session["ID_Contrato"] = idproy;
        Response.Redirect("~/Modulo_Ver/Consulta.aspx?ID_Proy=" + idproy);
    }
