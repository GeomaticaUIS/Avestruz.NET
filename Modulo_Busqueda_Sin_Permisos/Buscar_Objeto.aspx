<%@ Page Title="" Language="C#" MasterPageFile="~/Menus/Menu_Inicio_sinPermisos.master" AutoEventWireup="true" CodeFile="Buscar_Objeto.aspx.cs" Inherits="Modulo_Busqueda_Sin_Permisos_Buscar_Objeto" %>
    ...
    <div align="center">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
            ...
            SelectCommand="SELECT Proyectos.Id_Proyecto, Proyectos.Nombre, Proyectos.Registro_VIE 
                       FROM Proyectos INNER JOIN Contrato_Convenio 
                       ON Proyectos.Id_Proyecto = Contrato_Convenio.Id_Proyecto INNER JOIN Entidad_Contratante 
                       ON Contrato_Convenio.Entidad_Contratante = Entidad_Contratante.Id_Entidad_Contratante   
                       WHERE (Contrato_Convenio.Objeto LIKE '%' + @Nombre + '%' COLLATE SQL_LATIN1_GENERAL_CP1_CI_AI)
