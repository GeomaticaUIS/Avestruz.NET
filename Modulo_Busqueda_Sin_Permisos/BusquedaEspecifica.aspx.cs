...
public partial class Modulo_Busqueda_Sin_Permisos_BusquedaEspecifica : System.Web.UI.Page
{
    ...
    protected void Btn_BuscarNombre_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Modulo_Busqueda_Sin_Permisos/Buscar_Nombre.aspx");
    }
    protected void Btn_BuscarObjeto_Click(object sender, EventArgs e)
    {
        Session["Palabra_Buscar"] = Tbx_BuscarObjeto.Text;
        Response.Redirect("~/Modulo_Busqueda_Sin_Permisos/Buscar_Objeto.aspx");
    }
    protected void Btn_BuscarEntidad_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Modulo_Busqueda_Sin_Permisos/Buscar_Entidad.aspx");
    }
    ...
    protected void Btn_BuscarContrato_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Modulo_Busqueda_Sin_Permisos/Buscar_Contrato.aspx");
    }
    ...
    protected void Btn_BuscarProducto_Click(object sender, EventArgs e)
    {
        if(Opciones.SelectedIndex == 1)
        {
            ...
            Response.Redirect("~/Modulo_Busqueda_Sin_Permisos/Buscar_Producto_Proyecto.aspx");
        }
        if(Opciones.SelectedIndex == 2)
        {
            Session["Palabra_Buscar"] = Tbx_BuscarProductos.Text;
            Response.Redirect("~/Modulo_Busqueda_Sin_Permisos/Buscar_Proyecto_Producto.aspx");
        }
    }
}