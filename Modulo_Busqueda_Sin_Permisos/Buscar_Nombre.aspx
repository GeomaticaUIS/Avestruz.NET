<%@ Page Title="" Language="C#" MasterPageFile="~/Menus/Menu_Inicio_sinPermisos.master" AutoEventWireup="true" CodeFile="Buscar_Nombre.aspx.cs" Inherits="Modulo_Busqueda_Sin_Permisos_Buscar_Nombre" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%">
        <tr>
            <td class="style4">&nbsp;</td>
            <td align="right">
                <asp:TextBox ID="Txt_Buscar" runat="server" Height="30px" Width="250px" class="floatl__input"></asp:TextBox>
    ...
    <div align="center">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
            ...
            SelectCommand="SELECT Proyectos.Id_Proyecto, Proyectos.Nombre, Proyectos.Registro_VIE
                        FROM Proyectos
                        WHERE (Proyectos.Nombre LIKE '%' + @Nombre + '%' COLLATE SQL_LATIN1_GENERAL_CP1_CI_AI)
