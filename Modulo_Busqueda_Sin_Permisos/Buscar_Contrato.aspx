<%@ Page Title="" Language="C#" MasterPageFile="~/Menus/Menu_Inicio_sinPermisos.master" AutoEventWireup="true" CodeFile="Buscar_Contrato.aspx.cs" Inherits="Modulo_Busqueda_Buscar_VIE" %>
    ...
    <table width="100%" >
            <tr>
                <td class="style4">
                    &nbsp;</td>
                <td align="right">
                    <asp:TextBox ID="Txt_Buscar" runat="server" Height="28px" Width="250px" class="floatl__input"></asp:TextBox>
    ...
    <asp:listview id="ListView1" runat="server" datakeynames="ID Proyecto"
            ...
            <tr style="background-color: #E0FFFF;color: #333333;" class="contenedor">
                <td>
                    <asp:Label ID="ID_ProyectoLabel" runat="server" 
                        Text='<%# Eval("[ID Proyecto]") %>' />
                </td>
                <td>
                    <asp:Label ID="Nombre_del_ContratoLabel" runat="server" Text='<%# Eval("[Nombre del Contrato]") %>' />
                </td>
                <td>
                    <asp:Label ID="Entidad_ContratanteLabel" runat="server" 
                        Text='<%# Eval("[Entidad Contratante]") %>' />
                </td>
                <td>
                    <asp:Button ID="VerProyecto" runat="server" Text="Ver" Width="50px" onclick="VerProyecto_Click" class="boton opcion"/>
                </td>
        ...
        <ItemTemplate>
            <tr style="background-color: #FFFFFF; color: #284775;" class="contenedor">
                ...
                <td>
                    <asp:Button ID="Button5" runat="server" Text="Ver" onclick="VerProyecto_Click" class="boton opcion"/>
                </td>
            </tr>
        </ItemTemplate>
        <LayoutTemplate>
