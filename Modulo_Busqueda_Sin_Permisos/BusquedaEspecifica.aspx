<%@ Page Title="" Language="C#" MasterPageFile="~/Menus/Menu_Inicio_sinPermisos.master" AutoEventWireup="true" CodeFile="BusquedaEspecifica.aspx.cs" Inherits="Modulo_Busqueda_Sin_Permisos_BusquedaEspecifica" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 637px">
        ...
        <tr><td class="style5"></td>
            ...
            <td class="style4">
                <asp:TextBox ID="Tbx_BuscarNombre" class="floatl__input" runat="server" Height="28px" Width="305px"></asp:TextBox> 
        ...
        <tr><td class="style5">&nbsp;</td>
            ...
            <td class="style4">
                <asp:TextBox ID="Tbx_BuscarObjeto" class="floatl__input" runat="server" Height="28px" Width="305px" OnTextChanged="Tbx_Buscar2_TextChanged"></asp:TextBox> 
        ...
        <tr><td class="style5"></td>
            ...
            <td class="style4">
                <asp:TextBox ID="Tbx_BuscarContrato" class="floatl__input" runat="server" Height="28px" Width="305px"></asp:TextBox> 
        ...
        <tr>
            ...
            <td class="style4">
                <asp:DropDownList ID="Entidades" runat="server" Height="30px" Width="305px" class="dropdownlist"
        ...
        <tr>
            ...
            <td class="style4">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="Opciones" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="Opciones_SelectedIndexChanged" Height="30px" Width="305px" class="dropdownlist">
                            <asp:ListItem> -- </asp:ListItem>
                            <asp:ListItem> Asociados a un proyecto </asp:ListItem>
                            <asp:ListItem > Proyectos por productos </asp:ListItem>
                        </asp:DropDownList>
                        <br /><br />
                        <asp:TextBox ID="Tbx_BuscarProductos" class="floatl__input" runat="server" Height="28px" Width="305px"></asp:TextBox>
