<%@ Page Title="" Language="C#" MasterPageFile="~/Menus/Menu_Inicio_sinPermisos.master" AutoEventWireup="true" CodeFile="Buscar_Producto_Proyecto.aspx.cs" Inherits="Modulo_Busqueda_Sin_Permisos_Buscar_Producto_Proyecto" %>
                ...
                <tr style="background-color: #E0FFFF; color: #333333;" class="contenedor">
                    <td style="text-align: center">
                        <asp:Label ID="Id_ProductoLabel" runat="server"
                            Text='<%# Eval("Id_Productos") %>' />
                    </td>
                    <td style="text-align: justify">
                        <asp:Label ID="TipoLabel" runat="server" Text='<%# Eval("Tipo_Producto") %>' />
                    </td>
                    <td style="text-align: center">
                    ...
                    <td style="text-align: center">
                        <asp:Label ID="DescripcionLabel" runat="server"
                            Text='<%# Eval("Descripción_Producto") %>' />
                    </td>
                    <td>
                        <asp:Button ID="VerProducto" runat="server" Text="Ver" OnClick="VerProducto_Click" class="boton opcion" />
                    </td>
