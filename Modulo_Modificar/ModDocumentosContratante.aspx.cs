...
public partial class Modulo_Modificar_ModDocumentosContratante : System.Web.UI.Page
{
    ...
    public void Mostrar(int id_contrato)
    {
    ...
    protected void btn_eliminarCarta_Click(object sender, EventArgs e)
    {
        ...
        if (Label2.Text == "Archivo subido")
        {
            ...
            try
            {
                ...
                Subir_Carta.Enabled = true; //Habilitamos de nuevo el control para cargar archivos
    ...
    protected void Btn_Continuar_Click(object sender, EventArgs e)
    {
        ...
        Subir_Certificado.Enabled = true;
        Subir_Estudios.Enabled = true;
        Subir_RegistroP.Enabled = true;
        Subir_Terminos.Enabled = true;
        Btn_Carta.Enabled = true;
        Btn_Cdp.Enabled = true;
        Btn_Estudios.Enabled = true;
        Btn_Rp.Enabled = true;
        Btn_Terminos.Enabled = true;
        btn_eliminarCarta.Enabled = true;
        btn_EliminarTerminos.Enabled = true;
        btn_EliminarEstudios.Enabled = true;
        btn_EliminarCDP.Enabled = true;
        btn_EliminarRP.Enabled = true;
